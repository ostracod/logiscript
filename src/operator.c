...
operator_t operatorSet[] = {
    ...
    {(int8_t *)"+", OPERATOR_ADD, OPERATOR_ARRANGEMENT_BINARY, 6},
    {(int8_t *)"-", OPERATOR_SUBTRACT, OPERATOR_ARRANGEMENT_BINARY, 6},
    {(int8_t *)"-", OPERATOR_NEGATE, OPERATOR_ARRANGEMENT_UNARY, 4},
    {(int8_t *)"*", OPERATOR_MULTIPLY, OPERATOR_ARRANGEMENT_BINARY, 5},
    {(int8_t *)"/", OPERATOR_DIVIDE, OPERATOR_ARRANGEMENT_BINARY, 5},
    {(int8_t *)"%", OPERATOR_MODULUS, OPERATOR_ARRANGEMENT_BINARY, 5},
    {(int8_t *)"~", OPERATOR_BITWISE_NOT, OPERATOR_ARRANGEMENT_UNARY, 4},
    {(int8_t *)"|", OPERATOR_BITWISE_OR, OPERATOR_ARRANGEMENT_BINARY, 12},
    {(int8_t *)"&", OPERATOR_BITWISE_AND, OPERATOR_ARRANGEMENT_BINARY, 10},
    {(int8_t *)"^", OPERATOR_BITWISE_XOR, OPERATOR_ARRANGEMENT_BINARY, 11},
    {(int8_t *)"<<", OPERATOR_BITSHIFT_LEFT, OPERATOR_ARRANGEMENT_BINARY, 7},
    {(int8_t *)">>", OPERATOR_BITSHIFT_RIGHT, OPERATOR_ARRANGEMENT_BINARY, 7},
    {(int8_t *)"!", OPERATOR_LOGICAL_NOT, OPERATOR_ARRANGEMENT_UNARY, 4},
    {(int8_t *)"||", OPERATOR_LOGICAL_OR, OPERATOR_ARRANGEMENT_BINARY, 15},
    {(int8_t *)"&&", OPERATOR_LOGICAL_AND, OPERATOR_ARRANGEMENT_BINARY, 13},
    {(int8_t *)"^^", OPERATOR_LOGICAL_XOR, OPERATOR_ARRANGEMENT_BINARY, 14},
    {(int8_t *)"==", OPERATOR_EQUAL, OPERATOR_ARRANGEMENT_BINARY, 9},
    {(int8_t *)"!=", OPERATOR_NOT_EQUAL, OPERATOR_ARRANGEMENT_BINARY, 9},
    {(int8_t *)"===", OPERATOR_IDENTICAL, OPERATOR_ARRANGEMENT_BINARY, 9},
    {(int8_t *)"!==", OPERATOR_NOT_IDENTICAL, OPERATOR_ARRANGEMENT_BINARY, 9},
    {(int8_t *)">", OPERATOR_GREATER, OPERATOR_ARRANGEMENT_BINARY, 8},
    {(int8_t *)">=", OPERATOR_GREATER_OR_EQUAL, OPERATOR_ARRANGEMENT_BINARY, 8},
    {(int8_t *)"<", OPERATOR_LESS, OPERATOR_ARRANGEMENT_BINARY, 8},
    {(int8_t *)"<=", OPERATOR_LESS_OR_EQUAL, OPERATOR_ARRANGEMENT_BINARY, 8}
};
